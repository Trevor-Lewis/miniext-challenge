...
import AddEmailToAccount from '@/components/ui/AddEmailToAccount';
        ...
        <div className={styles.container}>
            ...
            {auth.type === LoadingStateTypes.LOADED && auth.user != null && (
                <>
                    ...
                    {/* NEED TO NOT RENDER CONTENT UNTIL THIS IS DONE!!!!! */}
                    {auth.user.email == null && <AddEmailToAccount />}
                        ...
                        <main className={styles.main}>
                            ...
                            <div className={styles.grid}>
                                ...
                                >
                                    ...
                                    <p>
                                        Deliver dynamic, personalized content with the lightweight
                                        Edge Runtime.
                                    </p>
                                </a>
                                <Logout />
